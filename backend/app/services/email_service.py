  ...
  <body style="margin:0;background:#f8fafc;font-family:Arial,sans-serif;color:#0f172a;">
    <div style="max-width:560px;margin:0 auto;padding:40px 20px;">
      ...
      <div style="margin-top:24px;background:#ffffff;border:1px solid #e2e8f0;border-radius:16px;padding:28px;">
        ...
        <a href="{safe_action_url}" style="display:inline-block;margin-top:24px;background:#1d4ed8;color:#ffffff;text-decoration:none;font-size:14px;font-weight:700;padding:12px 18px;border-radius:10px;">
          {safe_action_label}
        </a>
...
def send_verification_email(
    *,
    ...
    if (
        ...
        logger.info("Averlen verification link for %s: %s", email, verification_url)
...
def send_password_reset_email(
    *,
    ...
    if (
        ...
        logger.info("Averlen password reset link for %s: %s", email, reset_url)
